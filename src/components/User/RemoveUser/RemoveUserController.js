...
class RemoveUserController {
  ...
  async handler (request, response) {
    try {
      logger.info(`Usuário:${request.user.id} está tentando remover o usuário:${request.params.userId}.`)
      ...
      logger.info(`Usuário:${request.user.id} conseguiu remover o usuário:${request.params.userId}.`)
