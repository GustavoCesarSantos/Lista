...
describe('CREATE ANNOTATION SERVICE UNIT TEST', () => {
  test('Should create a valid annotation', async () => {
    ...
    const createAnnotationService = new CreateAnnotationService(annotationRepositoryFake)
    await expectExport(createAnnotationService.execute(annotation)).resolves.not.toThrow()
  })
})
