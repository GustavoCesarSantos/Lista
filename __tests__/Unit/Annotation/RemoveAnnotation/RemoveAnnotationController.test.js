...
describe('REMOVE ANNOTATION CONTROLLER UNIT TEST', () => {
  ...
  test('Should catch an error with default http status code', async () => {
    ...
    const RemoveAnnotationServiceFake = jest.fn().mockImplementation(() => {
      return {
    ...
    const createAnnotationController = new RemoveAnnotationController(createAnnotationServiceFake)
